...
//#pragma omp parallel for reduction( max: t_max ) default( shared ) // <-- UNCOMMENT FOR PARALLEL, ALSO LINE 9
        for(index_t i = 0; i < n; ++i) {
            ...
            for (index_t j = 0; j < n; ++j) {
                ...
                //if( i == j )
                //cout<<"finding same point "<<V.at(i)<<" "<<V.at(j)<<endl;
                //cout<<" distance "<<D.at(j)<<endl;
